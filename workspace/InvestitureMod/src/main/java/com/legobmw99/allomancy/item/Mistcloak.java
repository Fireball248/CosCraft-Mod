...
public class Mistcloak extends ItemArmor {
    ...
    public Mistcloak(ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot i, String registryName, String unlocalizedName) {
